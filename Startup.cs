...
namespace PEADotNetTraining
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IThaiDateService, ThaiDateService>();
            services.AddScoped<ThaiDateService>();
            services.AddDbContext<ApplicationDbContext>(options => options.UseSqlServer(_defaultConnectionString));
